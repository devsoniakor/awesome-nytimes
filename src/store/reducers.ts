import { ArticleActionType, LOAD_ARTICLES_SUCCESS, LOAD_ARTICLES_FAILED, LOAD_ARTICLES_IN_PROGRESS, FIND_ARTICLES_SUCCESS, FETCHING_STATUS, FIND_ARTICLES_IN_PROGRESS, ADD_TO_FAVOURITES, REMOVE_FAVOURITE, FavouritesActionType, Favourites } from "./types";
